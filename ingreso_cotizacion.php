        ...
        if ($return) {// if table form_cotizacion not empty
            ...
            if ($archivoXmlFormularios) {
                ...
                if($usuario_id != 0){
                    ...
                    //$sqlAsesor="select *from usuarios where id=".$usuario_id;
                ...
                $body = '<body style="margin: 10px;">
                        <div style="width: 600px; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">
                          <div align="center"><img src="images/cabecera.png" width="600" height="242">
                                <table width="600" border="0" align="center">
                                    <tr>
                                    <td style="text-align: center"><p>Hola,' . utf8_encode($form_cotizacion->nombre) .'  '.utf8_encode($form_cotizacion->apellido) . ' </p>
                                    <p style="color: #F00;">¡Te agradecemos por contactarnos!
                                    <p>Ahora ya estás más cerca de tu nuevo <strong>' . utf8_encode($nombreAuto) .'</strong></p>
                                      <p style="color: #000; font-size: 16px; margin-top: 35px;">Puedes visualizar la ficha técnica del auto que elegiste <a href="https://www.kia.com.ec/images/Fichas_Tecnicas/'.$her->getFichaTecnica($form_cotizacion->id_version).'">aquí</a></p>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td style="padding: 15px 20px; font-size: 16px;"><em>Nuestra Filosofía:</em> Creación de un nuevo futuro y la realización de los  sueños de la humanidad por pensar de forma creativa y hacer frente a retos de  frente</td>
                                    </tr>
                                    <tr>
                                      <td style="text-align: center"><img src="images/kia-rec.png" alt="" width="250" height="110"/></td>
                                    </tr>
                                    <tr>
                                      <td style="padding:5px 20px;text-align: center;"><p style="font-weight: bold; font-size: 16px;">Ya estamos trabajando en tu cotización, espérala!
                                      Pronto uno de nuestros asesores se comunicará contigo.</p></td>
                                    </tr>
                                </table>
                            </div>    
                            </div>
