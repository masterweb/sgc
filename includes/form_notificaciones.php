...
class FormNotificaciones {

    protected static $table_name = "notificaciones";
    protected static $db_fields = array(
        'user_id','caso_id','descripcion','leido','tipo_form','fecha');
    public $user_id;
    public $caso_id;
    public $descripcion;
    public $leido;
    ...
    // crea un nuevo objeto notificaciones
    ...
    public function getLastId() {
        ...
        $result = $database->getQueryCall($sql);
