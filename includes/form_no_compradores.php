...
class NoCompradores {
    ...
    protected static $table_name = "no_compradores";
    protected static $db_fields = array(
        'nombre', 'email','dealerid','grupoid');
    ...
    public function getNoCompradores($id){
        global $database;
        $sql = "SELECT * FROM no_compradores WHERE grupoid = {$id} LIMIT 1300,200";
        //die('sql: '.$sql);
