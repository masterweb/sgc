...
class FormExonerados {

    protected static $table_name = "form_vehiculos_exonerados";
    protected static $db_fields = array(
        'nombre', 'apellido','cedula', 'direccion','telefono','celular', 'email','id_modelos','id_version', 'cityid',
        'dealerid', 'id_atencion', 'fecha_form', 'ips','navegador','plataforma');
