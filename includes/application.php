...
final class JSite extends JApplication
{
	...
	public function getTemplate($params = false)
	{
		...
		//CUSTOM TEMPLATE FOR THE ARTICLE 608
		if (JRequest::getVar('id')=='608' && JRequest::getVar('option')=='com_content') {
		  $template->template = 'soul-ev';
		}

		//CUSTOM TEMPLATE FOR THE ARTICLE 610
		if (JRequest::getVar('id')=='611' && JRequest::getVar('option')=='com_content') {
		  $template->template = 'optimahybrid';
		}
                //CUSTOM TEMPLATE FOR THE ARTICLE 620
		if (JRequest::getVar('id')=='620' && JRequest::getVar('option')=='com_content') {
		  $template->template = 'soul';
		}
                //CUSTOM TEMPLATE FOR THE ARTICLE 621
		if (JRequest::getVar('id')=='621' && JRequest::getVar('option')=='com_content') {
		  $template->template = 'sportagegt';
		}
