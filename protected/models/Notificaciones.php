...
class Notificaciones extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('user_id, caso_id', 'numerical', 'integerOnly' => true),
            array('leido', 'length', 'max' => 255),
            array('descripcion', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, user_id, caso_id, descripcion, leido, fecha', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('caso_id', $this->caso_id);
