...
class UareaController extends Controller
{
	/**
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','admin','update','view','eliminar','search'),
				'users'=>array('@'),
			),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Area']))
		{
			...
			if($model->save()){
                ...
                $this->redirect(array('uarea/create'));
			}
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Area']))
		{
			...
			if($model->save()){
				...
				Yii::app()->user->setFlash('success', '<img src="' . Yii::app()->request->baseUrl . '/images/agradecimiento.png"/>');
                $this->redirect(array('uarea/update/'.$model->id));
			}
		}
	...
	public function actionSearch()
	{
		...
		if(!empty($_GET['Search']['Descripcion'])){
			...
			$posts = Area::model()->findAll(array('order' => 'id DESC', 'condition' => "descripcion LIKE :match", 'params' => array(':match' =>"%$patronBusqueda%")));
		   ...
		   if(!empty($posts)){
				...
				Yii::app()->user->setFlash('error', "No se encontraron datos con la busqueda realizada.");
				 $this->redirect(array('uarea/admin/'));
		   }
		}else{
