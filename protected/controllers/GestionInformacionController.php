...
//                echo '</pre>';die();
            ...
            if ($model->save()) {
                ...
                if($_POST['GestionInformacion']['fuente'] == 'exhibicion' || $_POST['GestionInformacion']['fuente'] == 'exhibicion quierounkiatd' || $_POST['GestionInformacion']['fuente'] == 'exhibicion_automundo_uio' || $_POST['GestionInformacion']['fuente'] == 'exhibicion_automundo_gye'){
