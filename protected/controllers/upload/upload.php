...
class Upload{
    ...
    /**
    *@var string contiene el nombre del archivo a ser subido.
    */
    var $FileName;
    /**
    *@var string contiene el nombre temporal del archivo.
    */
    var $TempFileName;
    /**
    *@var string contiene el directorio donde se subira la imagen.
    */
    var $UploadDirectory;
    /**
    *@var string contiene un array de exensiones permitidas.
    */
    var $ValidExtensions;
    /**
    *@var string contiene un mensaje para depuracion.
    */
    var $Message;
    /**
    ...
    */
    ...
    //@method bool returns whether the extension of file to be uploaded
    // is allowable or not.
    ...
    /**
    *@method bool returns whether the file size is acceptable.
    ...
    */
    ...
    /**
    *@method bool determins whether the file already exists. If so, rename $FileName.
    ...
    */
    ...
    /**
    *@method bool sends an email log to the administrator
