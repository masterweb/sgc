...
class alpha extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		$message = $this->message ? $this->message : Yii::t('alpha', '{attribute} contiene caracteres no permitidos');
	...
	public function clientValidateAttribute($object,$attribute)
	{
		...
		$pattern = $this->elaboratePattern();
		// get the error message
		$message = $this->message ? str_replace('{attribute}', $attribute, $this->message) : Yii::t('alpha', '{attribute} contiene caracteres no permitidos', array('{attribute}' => $attribute));
