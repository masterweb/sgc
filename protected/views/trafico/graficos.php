...
foreach ($vartrf['modelos'] as $val) {
    for ($i = 1; $i <= $vartrf['dia_actual']; $i++) {
        ...
        ${"traficodetalle_mes_anterior_".$val['id']}[] = $this->getTraficoVersion($vartrf['mes_anterior'], $val['id_versiones'], $vartrf['year_actual'], $d, 0, $vartrf['search'],$vartrf['cargo_id'], $vartrf['dealer_id'], $vartrf['id_responsable']); 
    }
}
foreach ($vartrf['modelos'] as $val) {
    for ($i = 1; $i <= $vartrf['dia_actual']; $i++) {
        ...
        ${"traficodetalle_mes_actual_".$val['id']}[] = $this->getTraficoVersion($vartrf['mes_actual'], $val['id_versiones'], $vartrf['year_actual'], $d, 0, $vartrf['search'],$vartrf['cargo_id'], $vartrf['dealer_id'], $vartrf['id_responsable']); 
...
<script type="text/javascript">
	$(function () {
		...
		$('#trafico_concesionario').change(function(){
                ...
                //    colors: ['#3E6899', '#A7B7D5', '#F39344', '#D90000', '#7E9746', '#685083', '#008C23','#C97A36','#4E80BB','#99B958','#7E629F','#4AA9C3']
                //});
                var chart;
		...
		Highcharts.chart('containerh'+<?php echo $k; ?>, {
                    ...
                    series: [{
                        name: '<?php echo $this->getNombreMesGraficas($vartrf['mes_anterior']); ?> - <?php echo $vartrf['dia_actual']; ?>',
                        data: [<?php for ($i = 0; $i < $vartrf['dia_actual']; $i++){
                            echo ${traficodetalle_mes_anterior_.$val['id']}[$i].',';
                        } ?>]
                    },{
                        name: '<?php echo $this->getNombreMesGraficas($vartrf['mes_actual']); ?> - <?php echo $vartrf['dia_actual']; ?>',
                        data: [
...
<div class="container">
	...
	<div class="row">
		<div class="col-md-6">
			<div id="container0" class="panel-body"></div>
			<div id="container1" class="panel-body"></div>
			<div id="container2" class="panel-body"></div>
			<div id="container3" class="panel-body"></div>
			<div id="container4" class="panel-body"></div>
			<div id="container5" class="panel-body"></div>
			<div id="container6" class="panel-body"></div>
			<div id="container7" class="panel-body"></div>
			<div id="container8" class="panel-body"></div>
			<div id="container9" class="panel-body"></div>
			<div id="container10" class="panel-body"></div>
			<div id="container11" class="panel-body"></div>
		</div>
		<div class="col-md-6">
		   <div id="containerv0" class="panel-body"></div>
			<div id="containerv1" class="panel-body"></div>
			<div id="containerv2" class="panel-body"></div>
			<div id="containerv3" class="panel-body"></div>
			<div id="containerv4" class="panel-body"></div>
			<div id="containerv5" class="panel-body"></div>
			<div id="containerv6" class="panel-body"></div>
			<div id="containerv7" class="panel-body"></div>
			<div id="containerv8" class="panel-body"></div>
			<div id="containerv9" class="panel-body"></div>
			<div id="containerv10" class="panel-body"></div>
			<div id="containerv11" class="panel-body"></div> 
		</div>
	</div> 
	<div class="row">
