...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            ...
            <?php else: ?>
            <h1 class="tl_seccion">Creaci&oacute;n de Encuesta</h1>
            <?php echo $this->renderPartial('_form', array('model' => $model,'idc'=>$idc)); ?>
            <?php endif; ?>
        </div>
        <div class="col-md-3 col-md-offset-1 cont_der">
            ...
            <ul>
                <li><a href="<?php echo Yii::app()->createUrl('cquestionario/admin/id/'.$idc); ?>" class="seguimiento-btn">Administrador de Encuestas</a></li>
