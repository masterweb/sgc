...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            ...
            <?php else: ?>
                <h1 class="tl_seccion">View Adjunto #<?php echo $model->id; ?></h1>
                <?php
        ...
        <div class="col-md-3 col-md-offset-1 cont_der">
            ...
            <ul>
                <li><a href="<?php echo Yii::app()->createUrl('pvQircomentarioFile/admin/id/' . $model->qirComentarioId); ?>" class="seguimiento-btn">Administrador Adjunto</a></li>
