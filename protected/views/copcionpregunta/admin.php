...
<div class="container">
    <div class="row">
	<?php
		$pregunta = Cpregunta::model()->findByPk($idc);
	?>
        <h1 class="tl_seccion">Opciones para : <i><?php echo $pregunta->descripcion;?></i></h1>
    </div>
	<div class="row">
            ...
            <div class="highlight">
                <div class="form">
                    ...
                    $form = $this->beginWidget('CActiveForm', array(
                        ...
                        'method' => 'get',
                        'action' => Yii::app()->createUrl('copcionpregunta/search/'.$idc),
    ...
    <div class="row">
		...
		<?php 
				...
				if(!empty($pregunta))
			?>
			<a href="<?php echo Yii::app()->createUrl('cpregunta/admin/'.$pregunta->cquestionario_id); ?>" class="btn btn-danger btn-xs  btnCrear"><< Regresar</a>
		...
		?>
			...
			<?php if( ($a->accesoSistema->controlador) == 'copcionpregunta' &&  ($a->accesoSistema->accion) ==  'create'){?>	
			
				<a href="<?php echo Yii::app()->createUrl('copcionpregunta/create/c/'.$idc); ?>" class="btn btn-primary btn-xs btn-danger btnCrear">Agregar Opci&oacute;n</a>
                        ...
                        <tr>
							...
							<?php 
								if(!empty($accesosUser)){
									foreach($accesosUser as $a){
							?>
							<?php if( ($a->accesoSistema->controlador) == 'copcionpregunta' &&  ($a->accesoSistema->accion) ==  'update'){?>	
									<td><a href="<?php echo Yii::app()->createUrl('copcionpregunta/update', array('id' => $c->id)); ?>" class="btn btn-primary btn-xs btn-danger">Editar</a></td>
							<?php } ?>
							
							
							<?php if( ($a->accesoSistema->controlador) == 'copcionpregunta' &&  ($a->accesoSistema->accion) ==  'eliminar'){?>	
									<td><a href="<?php echo Yii::app()->createUrl('copcionpregunta/eliminar', array('id' => $c->id)); ?>" onclick="return confirm('&iquest;Esta seguro que desea eliminar esta Pregunta?')" class="btn btn-primary btn-xs btn-danger">Eliminar</a></td>
							<?php } ?>
