...
<div class="container">
    <div class="row">
        <h1 class="tl_seccion">Encuestas realizadas en cotizaciones web</h1>
    </div>
	<div class="row">
	  ...
	  <div class="row">
		...
		<div class="col-md-12 pad-all">
			<a href="<?php echo Yii::app()->createUrl('cencuestadoscquestionario/atenciondetalle'); ?>"><input type="button" value="No Encuestados" id="encuestadosbtn" class="pad-all btn btn-success btn-sm"></a>
		</div>
	</div>
	<div class="row ">
        <div class="table-responsive col-md-12">
			<div class="row">
				<form class="form-inline" method="post" action="<?php echo Yii::app()->createUrl('cencuestadoscquestionario/atenciondetalleencuestado'); ?>">
            ...
            <table class="tables tablesorter" id="keywords">
                <thead>
                    <tr>
                        ...
                        <th colspan="2">Fecha de encuesta</th>
                    </tr>
                </thead>
...
//$model = Casos::model()->findAll();
                    ...
                    foreach ($model as $c){
                        ...
                        <tr>
                            ...
                            <td><?php echo $c->fecharealizado ?></td>
