            ...
            <?php if (Yii::app()->user->hasFlash('success')) { ?>
                ...
                <div class="">
                    <div class="row container filtros pad-all">
                        ...
                        <div class="col-sm-3">
                            <input size="60" maxlength="45" readonly="readonly" placeholder="Fecha desde" value="<?php echo date("Y-m-27") ?>" class="form-control datepicker cccc" name="Usuarios[desde]" id="Usuarios_desde" type="text">
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="row buttons col-sm-12 pad-all">
                            <p id="pp" class="alert-info" style="display:none; margin:5px auto; width:80%; background:#80ce80;text-align:center; color:white;padding:2px 2px 2px 5px;">Buscando... No presione el bot&oacute;n SELECCIONAR</p>
                            <input type=submit value="Seleccionar" id="btnSeleccion" style="margin:10px auto" class='btn btn-danger '>
                        </div>
                        <?php $this->endWidget(); ?>
                    </div>
                </div>
