	...
	<div class="row">
	  ...
	  <div class="row">
		...
		<div class="col-md-12 pad-all">
			<a href="<?php echo Yii::app()->createUrl('cencuestadoscquestionario/nocompradoresadmin'); ?>"><input type="button" value="No Encuestados" id="encuestadosbtn" class="pad-all btn btn-success btn-sm"></a>
		</div>
	</div>
    <div class="row ">
