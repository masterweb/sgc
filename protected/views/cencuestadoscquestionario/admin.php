...
<div class="container">
    <div class="row">
        <h1 class="tl_seccion">Campa&ntilde;as</h1>
    </div>
	<div class="row">
        ...
        <div class="table-responsive col-md-12">
            <table class="tables tablesorter" id="keywords">
                <thead>
                    <tr>
                        <th><span>ID</span></th>
                        <th><span>Campa&ntilde;a</span></th>
                        <th>Encuesta</th>
...
//$model = Casos::model()->findAll();
                    ...
                    foreach ($model as $c){
                        ...
                        <tr>
                            <td><?php echo $cont; ?> </td>
                            <td><?php echo $c->cquestionario->ccampana->nombre ?> </td>
                            <td><?php echo $c->cquestionario->nombre?> </td>
                            <?php 
