                ...
                if (diferencia <= dias) {
                    if (proximoSeguimiento != '') {
                        ...
                        if ($('#GestionInformacion_check').val() != 2) {
                            ...
                            var href = '/intranet/usuario/index.php/gestionDiaria/ical?startTime=' + fechaStart + startTime + '&endTime=' + fechaStart + endTime + '&subject=Agendamiento Cita Cliente <?php echo $nombre_cliente; ?>&desc=Cita con el cliente presentacion:  <?php echo $nombre_cliente; ?>&location=Por definir&to_name=' + cliente + '&conc=<?php echo $nombreConcesionario; ?>';
