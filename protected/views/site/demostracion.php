    ...
    <div role="tabpanel">
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="profile">
                ...
                if ($continuar_status == count($vec) || $ex->fuente_contacto == 'exhibicion' || $ex->fuente_contacto == 'web' || $ex->fuente_contacto == 'exhibicion quierounkiatd' || $ex->fuente_contacto == 'exhibicion quierounkia'):
                    ?>
                    <div class="row">
                        <div class="col-md-3">
