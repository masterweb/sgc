                                    ...
                                    <table class="tables tablesorter" id="keywords">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo '<a href="' . Yii::app()->request->baseUrl . '/images/LISTA-DE-PRECIOS-KIA-04-01-2017-2.pdf" class="btn btn-default btn-xs" type="submit" name="yt0" target="_blank">Lista de Precios</a>'; ?></td>
                                            </tr>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($vec as $c):
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo '<a href="' . Yii::app()->request->baseUrl . '/images/LISTA-DE-PRECIOS-KIA-04-01-2017-2.pdf" class="btn btn-warning btn-xs" type="submit" name="yt0" target="_blank">Lista de Precios</a>';
                                            ; ?></td>
                                            </tr>
                                            <?php
                                        endforeach;
