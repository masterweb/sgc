    ...
    <!--                                                <select name="Cotizador[modelo]" id="Cotizador_modelo" class="form-control">
                    ...
                    <div class="row buttons">
                        <div class="col-md-7">
                            ...
                            <?php
                            if ($_GET['tipo'] == 'prospeccion') {
                                echo '<a href="' . Yii::app()->request->baseUrl . '/images/LISTA-DE-PRECIOS-KIA-01-06-20171.pdf" class="btn btn-warning" type="submit" name="yt0" target="_blank">Lista de Precios</a>';
                            }
                            ?>
