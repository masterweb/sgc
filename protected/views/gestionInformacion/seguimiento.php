                        ...
                        $.ajax({
                            ...
                            //alert(data);
                                ...
                                if (data.result != false){
                                    var dt = '<a href="https://www.kia.com.ec/intranet/usuario/index.php/gestionInformacion/create/' + data.id_nueva_cotizacion + '?tipo=gestion&fuente='+fuente+'&iden=cedula" class="btn btn-danger">Nueva Cotización</a>';
                        ...
                        if (resp != true){
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if (data.result != false){
                                        var dt = '<a href="https://www.kia.com.ec/intranet/usuario/index.php/gestionInformacion/create/' + data.id_nueva_cotizacion + '?tipo=gestion&fuente='+fuente+'&iden=ruc" class="btn btn-danger">Nueva Cotización</a>';
                                        $('.cont-createc-but').html(dt);
                                    }
                                    else if (data.result == false && data.flagttga35 == false && data.flagttga36 == false && data.flagvh01 == false){
                                        form.submit();
