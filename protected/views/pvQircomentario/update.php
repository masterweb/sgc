...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            ...
            <?php else: ?>
                <h1 class="tl_seccion">Update Comentario <?php echo $model->id; ?></h1>
        ...
        <div class="col-md-3 col-md-offset-1 cont_der">
            ...
            <ul>
                <li><a href="<?php echo Yii::app()->createUrl('pvQircomentario/admin/id/' . $model->qirId); ?>" class="seguimiento-btn">Administrador Comentarios</a></li>
