...
<?php endif; ?>
    ...
    var valorentrada = format2(<?php echo $model->cuota_inicial; ?>, '$');
    $('#GestionFinanciamiento_entrada').val(valorentrada);
    
    var valorfinanciamiento = format2(<?php echo $model->valor_financiamiento; ?>, '$');
    $('#GestionFinanciamiento_valor_financiamiento').val(valorfinanciamiento);
    
    var valorseguro = format2(<?php echo $model->seguro; ?>, '$');
    $('#GestionFinanciamiento_seguro').val(valorseguro);
    
    var cuotamensual = format2(<?php echo $model->cuota_mensual; ?>, '$');
                        ...
                        <div class="cont-proforma">
                                                    ...
                                                    <?php foreach ($rows1 as $key => $value): ?>
                                                        <div class="row">
                                                            <div class="col-md-7">
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" value="<?php echo $value['precio'] . '-' . $value['accesorio']; ?>" name="accesorios[]" id="accesorio-<?php echo $count; ?>" <?php if ($value['codigo'] == 7 && $tipo == 1) { ?> disabled="" class="def" <?php } ?> <?php $this->getCheckedAcc($value['precio'] . '-' . $value['accesorio'],$stringAccesorios ); ?>>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="precio_accesorios" id="precio_accesorios" class="form-control input-acc" value="<?php echo $model->precio_vehiculo; ?>" data-symbol="$ " data-thousands="." data-decimal=",">
                                    <input type="hidden" name="precio_accesorios_anterior" id="precio_accesorios_anterior" value="<?php echo $model->precio_vehiculo; ?>"/>
                                </div>
                            </div>
                            <br />
                            <?php if ($tipo == 1): // credito            ?>
<!-- ==================================INICIO COTIZACION A CREDITO===================================-->
                            <div class="cont-financ">
                                ...
                                <div class="row">
                                    <div class="col-md-4 cont-options1">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="GestionFinanciamiento1[precio]" id="GestionFinanciamiento_precio" class="form-control" onkeypress="return validateNumbers(event)" value="<?php echo $this->getPrecio($id_vehiculo, $tipo) ?>"/>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                    ...
                                    ?>
                                    <div class="col-md-4 cont-options2">
                                        <div class="row">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="">Precio Vehículo</label>
                                                <input type="text" name="GestionFinanciamiento2[precio]" id="GestionFinanciamiento_precio2" class="form-control" onkeypress="return validateNumbers(event)" value="<?php if($fi == 1){echo $fin1->precio_vehiculo; }else{echo $this->getPrecio($id_vehiculo, $tipo);} ?>"/>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="">Valor de Entrada</label>
                                                <input type="text" name="GestionFinanciamiento2[entrada]" id="GestionFinanciamiento_entrada2" class="form-control" onkeypress="return validateNumbers(event)" value="<?php echo $fin1->cuota_inicial; ?>"/>
                                    ...
                                    <div class="col-md-4 cont-options3" style="display: none;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="">Precio Vehículo</label>
                                                <input type="text" name="GestionFinanciamiento3[precio]" id="GestionFinanciamiento_precio3" class="form-control" onkeypress="return validateNumbers(event)" value="<?php echo $this->getPrecio($id_vehiculo, $tipo) ?>"/>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
