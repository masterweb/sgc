...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            ...
            <?php else: ?>
            <h1 class="tl_seccion">Ver Modelo PostVenta</h1>
        ...
        <div class="col-md-3 col-md-offset-1 cont_der">
            ...
            <ul>
                <li><a href="<?php echo Yii::app()->createUrl('pvmodelosposventa/admin'); ?>" class="seguimiento-btn">Seguimiento de Modelo PostVenta</a></li>
