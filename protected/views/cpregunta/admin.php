...
<div class="container">
	...
	?>
        <h1 class="tl_seccion">Preguntas para : <i><?php echo $encuesta->nombre;?></i></h1>
    </div>
	<div class="row">
            ...
            <div class="highlight">
                <div class="form">
                    ...
                    $form = $this->beginWidget('CActiveForm', array(
                        ...
                        'method' => 'get',
                        'action' => Yii::app()->createUrl('cpregunta/search/'.$idc),
    ...
    <div class="row">
		...
		?>
			...
			<?php if( ($a->accesoSistema->controlador) == 'cpregunta' &&  ($a->accesoSistema->accion) ==  'create'){?>	
				<a href="<?php echo Yii::app()->createUrl('cpregunta/seleccion/c/'.$idc); ?>" class="btn btn-primary btn-xs btn-danger btnCrear">Crear Pregunta</a>
			<?php } ?>
		...
		?><a href="<?php echo Yii::app()->createUrl('cquestionario/admin/id/'.$encuesta->ccampana_id); ?>" class="btn btn-primary btn-xs btn-danger btnCrear">Regresar</a>
