                ...
                <?php $form=$this->beginWidget('CActiveForm', array(
                    ...
                    <div id="opciones" class="row highlight">
                        <table class="table" id="tabla">
                            ...
                            <tr class="fila-base">
                                <td>
                                    <input type="text" name="opciontxt[]" class="form-control vl">
                                </td>
                                <td class="eliminar">
                            ...
                            <?php 
                                ...
                                if(!empty($opcionesR)){
                                    foreach ($opcionesR as $key) {
                                        echo '<tr>';
                                        echo '<td>
                                                    <input type="text" name="opciontxt[]" class="form-control vl" value="'.$key->detalle.'">
                                                </td>
                                                <td class="eliminar">
                    ...
                    <!--columnas-->
                     <div id="opciones" class="row highlight">
                        <table class="table" id="tablaC">
                            ...
                            <?php 
                                $opcionesR = Cmatrizpregunta::model()->findAll(array('condition'=>'cpregunta_id='.$model->id));
                                if(!empty($opcionesR)){
                                    foreach ($opcionesR as $key) {
                                        echo '<tr>';
                                        echo '<td>
                                                    <input type="text" placeholder="Descripción de la opción" name="columnatxt[pregunta][]" class="form-control vr" value="'.$key->detalle.'">
                                                </td>
                                                <td>
                                                    <input type="text" placeholder="Valor de la Opción" name="columnatxt[valor][]" class="form-control vrv" value="'.$key->valor.'">
                                                </td>
                                                <td class="eliminarC">
