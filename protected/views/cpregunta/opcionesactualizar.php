                ...
                <?php $form=$this->beginWidget('CActiveForm', array(
                    ...
                    <div id="opciones" class="row highlight">
                        <table class="table" id="tabla">
                            <thead>
                                <tr>
                                    ...
                                    <td>&iquest;Crear subpregunta?</td>
							 ...
							 <?php 
                                ...
                                if(!empty($opcionesR)){
                                    ...
                                    foreach ($opcionesR as $key) {
										$chk = (!empty($key->valor))?'checked="true"':''; 
                                        echo '<tr class="vvl">';
										$subpreguntas = Cpregunta::model()->count(array('condition'=>'copcionpregunta_id='.(int)$key->id));
										$admin = '';
										if($subpreguntas>0){
											//$admin = '<a href="'.Yii::app()->createUrl('cpregunta/subadmin/id/'.$idc.'/opcion/'.$key->id).'">&nbsp;-&nbsp;Administrar</a>';
										}
                                        echo '<td>
												...
												<td>
													<input type="checkbox" value="1" name="opciontxt['.$cont.'][justifica]" '.$chk.' class="form-control vl">
												</td>
												 <td class="subpregunta">
													
													<a href="'.Yii::app()->createUrl('cpregunta/subadmin/id/'.$idc.'/opcion/'.$key->id).'">&nbsp;Agregar ('.$subpreguntas.')</a>
												</td>
                                                <td class="eliminar">
					 ...
					 <div class="form-group pad-all">
                        ...
                        <div class="col-sm-9">
                        <?php echo $form->textField($model,'orden',array('size'=>60,'maxlength'=>350, 'class' => 'form-control')); ?>
                        <?php echo $form->error($model,'orden'); ?>
                        </div>
                    </div>
                    <div class="row buttons">
                        <a href="<?php echo Yii::app()->createUrl('cpregunta/admin/id/'.$idc); ?>"><input type="button" value="<< Regresar" class="btn btn-danger"></a>
