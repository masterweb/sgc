...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            ...
            <?php else: ?>
            <h1 class="tl_seccion">Actualizaci&oacute;n de Modelos PostVenta</h1>
        ...
        <div class="col-md-3 col-md-offset-1 cont_der">
            ...
            <ul>
              <li><a href="<?php echo Yii::app()->createUrl('pvcodigoNaturaleza/admin'); ?>" class="seguimiento-btn">Administrador de C&oacute;digos Naturaleza</a></li>
