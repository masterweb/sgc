...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            ...
            <?php else: ?>
            <h1 class="tl_seccion">Actualizaci&oacute;n de Boletines PostVenta</h1>
            <?php echo $this->renderPartial('_form', array('model' => $model,'control' =>$control,'models'=>$models,)); ?>
            <?php endif; ?>
        </div>
        <div class="col-md-3 col-md-offset-1 cont_der">
            ...
            <ul>
              <li><a href="<?php echo Yii::app()->createUrl('pvboletinpostventa/admin'); ?>" class="seguimiento-btn">Administrador de Bolet&iacute;nes Posventa</a></li>
