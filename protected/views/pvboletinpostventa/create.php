...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            ...
            <?php else: ?>
            <h1 class="tl_seccion">Creaci&oacute;n de Bolet&iacute;n</h1>
        ...
        <div class="col-md-3 col-md-offset-1 cont_der">
            ...
            <ul>
                <li><a href="<?php echo Yii::app()->createUrl('pvboletinpostventa/admin'); ?>" class="seguimiento-btn">Administrador de Boletines Posventa</a></li>
