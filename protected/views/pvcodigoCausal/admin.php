...
<div class="container">
    <div class="row">
        <h1 class="tl_seccion">C&oacute;digo Causal</h1>
    </div>
	<div class="row">
            ...
            <div class="highlight">
                <div class="form">
                    ...
                    $form = $this->beginWidget('CActiveForm', array(
                        ...
                        'method' => 'get',
                        'action' => Yii::app()->createUrl('pvcodigoCausal/search'),
    ...
    <div class="row">
		...
		<div>
			...
			<?php if( ($a->accesoSistema->controlador) == 'pvcodigoCausal' &&  ($a->accesoSistema->accion) ==  'create'){?>	
				<a href="<?php echo Yii::app()->createUrl('pvcodigoCausal/create'); ?>" class="btn btn-primary btn-xs btn-danger btnCrear">Crear C&oacute;digo Causal</a>
			<?php } ?>
			<?php if( ($a->accesoSistema->controlador) == 'pvcodigoCausal' &&  ($a->accesoSistema->accion) ==  'adjunto'){?>
				<a href="<?php echo Yii::app()->createUrl('pvcodigoCausal/adjunto'); ?>" class="btn btn-primary btn-xs btn-danger btnCrear">Cargar Excel</a>
			<?php } ?>
		</div>
		<?php
				}
                        ...
                        <tr>
							...
							<?php 
								if(!empty($accesosUser)){
									foreach($accesosUser as $a){
							?>
							<?php if( ($a->accesoSistema->controlador) == 'pvcodigoCausal' &&  ($a->accesoSistema->accion) ==  'update'){?>	
									<td><a href="<?php echo Yii::app()->createUrl('pvcodigoCausal/update', array('id' => $c->id)); ?>" class="btn btn-primary btn-xs btn-danger">Editar</a></td>
							<?php } ?>
							
							
							<?php if( ($a->accesoSistema->controlador) == 'pvcodigoCausal' &&  ($a->accesoSistema->accion) ==  'eliminar'){?>	
									<td><a href="<?php echo Yii::app()->createUrl('pvcodigoCausal/eliminar', array('id' => $c->id)); ?>" onclick="return confirm('&iquest;Esta seguro que desea eliminar este C&oacute;digo Causal?')" class="btn btn-primary btn-xs btn-danger">Eliminar</a></td>
							<?php } ?>
							
							<?php if( ($a->accesoSistema->controlador) == 'pvcodigoCausal' &&  ($a->accesoSistema->accion) ==  'view'){?>	
									<td><a href="<?php echo Yii::app()->createUrl('pvcodigoCausal/view', array('id' => $c->id)); ?>" class="btn btn-primary btn-xs btn-danger">Ver</a></td>
							<?php } ?>
