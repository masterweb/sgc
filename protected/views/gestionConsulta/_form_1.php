...
<style type="text/css">
    ...
    .radio, .checkbox{font-sizSeguimientoe: 15 px !important;}
</style>
    ...
    $(document).ready(function () {
        ...
        $('#GestionConsulta_vec').change(function () {
            ...
            if (value === '0') {// primer vehiculo
                ...
                $("#GestionConsulta_preg3 option[value=0]").removeAttr('selected');
            }
        })
                ...
                <div class="highlight"><!-- Seguimiento -->
                    ...
                    <div class="form cont-seguimiento">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <?php echo $form->dropDownList($consulta, 'preg7', array('' => '-Seleccione-',
                ...
                <div class="highlight">
                    ...
                    <div class="form">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                echo $form->dropDownList($agendamiento, 'categorizacion', array(
                                    ...
                                    '1' => 'Hot A(hasta 7 dias)',
                                    '2' => 'Hot B(hasta 15 dias)',
                                    '3' => 'Hot C(hasta 30 dias)',
                                    '4' => 'Warm(hasta 3 meses)',
                                    '5' => 'Warm(hasta 6 meses)',
                                    '6' => 'Very Cold(mas de 6 meses)'), array('class' => 'form-control'));
                                ?>
                        ...
                        <div class="row buttons">
                            ...
                            <input type="hidden" name="GestionAgendamiento[paso]" id="GestionAgendamiento_paso" value="3">
                            <input type="hidden" name="GestionAgendamiento[pasoconsulta]" id="GestionAgendamiento_pasoconsulta" value="1">
