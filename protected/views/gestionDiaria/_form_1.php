                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                      ...
                      <div class="panel panel-default">
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                          <div class="panel-body">
                            <?php 
                            $pv = GestionAgendamiento::model()->findAll(array(
                                'condition' => "id_informacion=:match AND paso=4",
                            ...
                            <?php
                            foreach ($pv as $vpv) {
                                echo '<div class="col-md-6">Fecha Seguimiento</div>'
                                . '<div class="col-md-6">'.$vpv['agendamiento'].'</div>';
                            }
                            ?>
                          </div>
                        </div>
                      ...
                      <div class="panel panel-default">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                          <div class="panel-body">
                            ...
                            ?>
                            <div class="col-md-6"><strong>Paso</strong></div>
                            <div class="col-md-6"><strong>Fecha seguimiento</strong></div>
                              <?php
                            foreach ($seg as $vseg) {
                                echo '<div class="col-md-6">'.$this->getPasoSeguimiento($vseg['paso']).'</div>'
                                . '<div class="col-md-6">'.$vseg['agendamiento'].'</div>';
                            }
                            ?>
                          </div>
                        </div>
