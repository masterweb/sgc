        ...
        if ($return) {// if table form_cotizacion not empty
            ...
            if ($archivoXmlFormularios) {
                ...
                if($usuario_id != 0){
                    ...
                    $sqlAsesor="SELECT nombres, apellido,correo,telefono,direccion,google_maps
                ...
                $nombreSolicitud=$nombre." ".$apellidos;
                
                $nombreSolicitud=str_replace("'", "", $nombreSolicitud);
                $body = '<style>
                    ...
                    <body>
                        <table cellpadding="0" cellspacing="0" width="650" align="center" border="0">
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td align="center"><a href="https://www.kia.com.ec/images/Fichas_Tecnicas/'.$her->getFichaTecnica($form_cotizacion->id_version).'" target="_blank"><img src="https://www.kia.com.ec/images/mailing/'.$form_cotizacion->id_modelos.'.jpg" width="570" height="240" alt="" style="display:block; border:none;"/></a></td>
                                </tr>
                                <tr>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0" align="center">
                                                <tr>
                                                    ...
                                                    <td><a href="'.$rowAsesor["google_maps"].'" target="_blank"><img src="images/mailing/mail_factura_09.jpg" width="256" height="226" alt=""/></a></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
